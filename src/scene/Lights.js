...
export class Lights {
  constructor(scene) {
    this.ambient = new THREE.AmbientLight('#c8e5ff', 0.48);
    this.key = new THREE.DirectionalLight('#ffffff', 4.25);
    this.key.position.set(-5, 10, -5);
    this.key.castShadow = true;
    this.key.shadow.mapSize.set(1024, 1024);
    this.fill = new THREE.DirectionalLight('#7fb6ff', 0.78);
    this.fill.position.set(6, 4, 8);
    this.rim = new THREE.PointLight('#35d6c6', 32, 48);
